                    ...
                    <tbody>
                        ...
                        <tr class="cart_item">
                            ...
                            <td class="cart-product-thumbnail">
                                <a href="{{ route('product.show',$item->options->product->slug) }}"><img width="64" height="64" src="{{ $item->options->attribute->images }}" alt="{{ $item->name }}"></a>
                            </td>

                            <td class="cart-product-name">
                                <a href="{{ route('product.show',$item->options->product->slug) }}">{{ $item->name }}</a>
                                <br>
                                <span>Style: {{ $item->options->attribute->attribute_style }} </span>
                                <br>
                                <span>Color: {{ $item->options->attribute->attribute_color }} </span>
                                <br>
                                <span>Size: {{ $item->options->attribute->attribute_size }} </span>
                            </td>
