        ...
        <div class="col_half col_last fright nobottommargin">
            ...
            <div class="top-links">
                <ul>
                    ...
                    <li><a href="#">EN</a>
                        <ul>
                            <li><a href="#"><img src="{{ frontend_asset('images/icons/flags/french.png') }}" alt="French"> FR</a></li>
                            <li><a href="#"><img src="{{ frontend_asset('images/icons/flags/italian.png') }}" alt="Italian"> IT</a></li>
                            <li><a href="#"><img src="{{ frontend_asset('images/icons/flags/german.png') }}" alt="German"> DE</a></li>
                        </ul>
                    </li>
                    <li><a href="#">Login</a>
...
<header id="header">
    ...
    <div id="header-wrap">
        ...
        <div class="container clearfix">
            ...
            ============================================= -->
            <div id="logo">
                <a href="index.html" class="standard-logo" data-dark-logo="{{ frontend_asset('images/logo-dark.png') }}"><img src="{{ frontend_asset('images/logo.png') }}" alt="Canvas Logo"></a>
                <a href="index.html" class="retina-logo" data-dark-logo="{{ frontend_asset('images/logo-dark@2x.png') }}"><img src="{{ frontend_asset('images/logo@2x.png') }}" alt="Canvas Logo"></a>
            </div><!-- #logo end -->
                        ...
                        <div class="top-cart-items">
                            <div class="top-cart-item clearfix">
                                <div class="top-cart-item-image">
                                    <a href="#"><img src="{{ frontend_asset('images/shop/small/1.jpg') }}" alt="Blue Round-Neck Tshirt" /></a>
                                </div>
                            ...
                            <div class="top-cart-item clearfix">
                                <div class="top-cart-item-image">
                                    <a href="#"><img src="{{ frontend_asset('images/shop/small/6.jpg') }}" alt="Light Blue Denim Dress" /></a>
                                </div>
                                <div class="top-cart-item-desc">
